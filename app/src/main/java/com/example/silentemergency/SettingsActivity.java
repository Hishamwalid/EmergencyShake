...
public class SettingsActivity extends AppCompatActivity {
    ...
    // ✅ NEW: Destination picker launcher (FIXED)
    ...
    private void getCurrentLocation() {
        ...
        String addr = getAddressFromLatLng(loc.getLatitude(), loc.getLongitude());

        if (addr != null) {
            prefManager.setStartingPoint(addr);
        } else {
            prefManager.setStartingPoint(loc.getLatitude() + "," + loc.getLongitude());
        }
